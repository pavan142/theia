...
//             selectNodes(['1.1'], TreeSelection.SelectionType.TOGGLE);
...
//     function selectNodes(ids: string[], type: TreeSelection.SelectionType = TreeSelection.SelectionType.DEFAULT): void {
//         ids.map(findNode).forEach(node => model.addSelection({ node, type }));
//     }
